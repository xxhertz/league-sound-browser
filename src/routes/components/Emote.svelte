...
<div class="text-eggshell bg-gradient-to-b h-80 w-80 rounded-2xl mb-4 mt-4 mx-auto hover:via-eggshell/20 via-eggshell/0 transition-all duration-200 from-zinc-950 to-zinc-950">
