...
<button on:click={() => audio.play()} class="group-hover:bg-opacity-75 bg-opacity-0 inset-0 rounded-2xl bg-zinc-950 w-full h-full absolute top-0 left-0 transition-colors duration-100">
